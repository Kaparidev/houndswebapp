<%-- 
    Document   : sheperds
    Created on : 16 May 2017, 7:55:35 PM
    Author     : LAB0040PC050
--%>
...
<html>
    <head>
        ...
        <title>German Sherperds</title>
    </head>
    <body>
        <h1>Choose your favorite German Sherperd!</h1>
        ...
        <table border="1">
            ...
            <tr>
                <td><img src="<%=Utility.getSherperds().get(x).getImage()%>" width="400px" height="350px"></td>
